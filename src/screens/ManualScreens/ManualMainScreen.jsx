  ...
  return (
    <div className="min-h-screen min-w-full bg-[#1d1f23]">
      ...
      <main className="container mx-auto flex items-start justify-between ">
        <aside className="min-w-[280px] min-h-[980px]  bg-[#26272a] text-white self-start ">
        ...
        <div className="min-w-[80%] min-h-[980px]  bg-[#1d1f23] flex flex-col justify-between items-center gap-3">
          {/* middle-div-start */}
          <div className="bg-[#1d1f23]  min-w-full flex flex-row gap-3">
            {/* left-start */}
            <div className="bg-[#26272b] w-80 pt-2 px-1">
                      ...
                      <form className="flex flex-col gap-3">
                        <label className="relative flex flex-col  text-white ">
                          ...
                          <div className="flex flex-row items-center justify-between p-1 bg-[#2f3034] rounded-lg">
                            <input
                              type="text"
                              className="border-none rounded h-9 w-48 p-1 bg-[#1d1f23]"
                            />
                            <img
                              src={heroTron}
                          ...
                          <Tab.Panels className="mt-2">
                            <Tab.Panel>
                              <form className="flex flex-col gap-3">
                                ...
                                <label className="relative flex flex-col  text-white ">
                                  <div className="bg-[#26272b] flex justify-between items-end font-roboto_condensed text-sm ">
                                    <h4 className="opacity-40">Stop on Loss</h4>
                                    <h4 className="opacity-40">$0.00</h4>
                                  </div>
                                  <div className="flex flex-row items-center justify-between p-1 bg-[#2f3034] rounded-lg">
                                    <input
            ...
            {/* left-end */}
            {/* right-start */}
            <div className="bg-[#232428] h-auto flex-grow relative flex flex-col justify-between ">
              <div className="h-[8%] w-full bg-[#232428] flex items-center justify-end text-white font-roboto_condensed gap-3">
                <button
                  type="button"
                  className="bg-[#2f3034] w-16  h-8 flex justify-center items-center rounded-full text-sm font-bold"
                >
                  1.69x
                </button>
                <button
                ...
                <button
                  type="button"
                  className="bg-[#2da37f] w-16  h-8 flex justify-center items-center rounded-full text-sm font-bold"
                >
                  88.11x
                </button>
                <button
              ...
              <div className="h-[80%] w-[100%] p-3 flex flex-row justify-start">
                ...
                <div className="w-auto h-[92%]  bg-[#232428] text-white flex flex-col justify-between relative ">
          ...
          {/* lower-div-start */}
          <div className="bg-[#26272b] flex-grow min-w-full h-[290px] p-3">
            <div
            ...
            >
              <Tab.Group>
                <Tab.List className="flex space-x-1 rounded-full bg-[#1d1f23] p-1 w-[30%]">
                  {BottomPanel.map((e) => (
                    <Tab
                      key={e}
                      className={({ selected }) =>
                        ...
                        {Array(10)
                          ...
                          .map((e, i) => (
                            <li className="flex gap-2 text-xs" key={i}>
                              <h1 className="opacity-60 text-white ">01.29</h1>
